...
use crate::{Action, BUTTON_A, BUTTON_X, BUTTON_Y, Controller, Error, Fighter, data::FighterData};
use physics::{Movement, locomotion as math};
...
fn enter(f: &mut Fighter, action: Action) {
    ...
    crate::simulation::enter(f, action);
}

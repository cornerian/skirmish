...
unsuccessfully on mismatch or unsupported input. Its `fighter-post-v6` policy
...
and last-hit action-instance IDs from 3.16 onward. Matching those fields does
not certify complete state or Melee gameplay.

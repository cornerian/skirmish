...
| `game` | Experimental native two-player match: stage/ECB collision, animated attacks and catches, paired capture/four-direction throws, damage and DI, KOs, stocks, respawn, timeout, checkpoints and replay-stepper integration |

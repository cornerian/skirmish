...
unsuccessfully on mismatch or unsupported input. Its `fighter-post-v4` policy
...
and the hitstun counter for two human leaders. It also checks all five recorded
velocity components from Slippi 3.5 onward and hitlag from 3.8

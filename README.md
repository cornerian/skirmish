...
| `renderer` feature and module | SDL3 window/events/controllers, wgpu scene presentation, direct Melee UI hosting, build-time WESL shaders, offscreen PNG output and CPAL procedural audio cues |

...
contact, knockback, DI, hitlag, damage reflection, floor/wall-tech selection, walking, running-turn physics, jump, neutral-special input, blast-death selection and RNG, rebirth travel, stage query/remapping and ECB
...
Match integration tests cover slopes, walls, ceilings, damage reflection,
floor/wall/ceiling techs and sampled roll bones/root motion, static and moving platforms,
moving-surface penetration, opposing-surface ECB squeeze/restoration, swept attack

...
contact, knockback, DI, hitlag, damage reflection, floor/wall-tech selection, walking, jump, neutral-special input, blast-death selection and RNG, rebirth travel, stage query/remapping and ECB

...
The renderer's menu bindings use South or Start to confirm and either East or
West to go back. Accepting both Back positions keeps standard gamepad East and
the GameCube's physical B usable. This is a menu presentation policy; gameplay
controller calibration and button semantics remain separate.

...
and released wall-tech actions enter `SpecialAirN`. DamageFall and reflected
wall/ceiling actions also enter it after hitstun reaches zero. Special selection

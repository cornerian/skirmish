...
Airborne Damage, DamageFall and reflected wall/ceiling actions gain the same two
branches when hitstun reaches zero; earlier presses remain blocked and require a
fresh edge.
